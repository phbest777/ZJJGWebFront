<template>
  <div class="table-container">
    ...
    ></el-pagination>
    <redo-table-edit ref="edit-add" @refresh-data="fetchData"></redo-table-edit>
    <redo-edit ref="edit-show" @refresh-data="fetchData"></redo-edit>
  </div>
</template>
...
<script>
  ...
  import RedoEdit from './components/RedoEdit'
  import RedoTableEdit from './components/RedoTableEdit'
